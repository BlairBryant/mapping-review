...
export default class EventCard extends Component {
    ...
    componentDidMount() {
        this.setState({editName: this.props.event.name, editTitle: this.props.event.title, editDesc: this.props.event.desc})
    }

    editClick() {
        if(this.state.editToggle) {
            this.props.editEvent({id: this.props.event.id, name: this.state.editName, title: this.state.editTitle, desc: this.state.editDesc})
        }
